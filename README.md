...
* `locations.geojson` contains the detailed case location information for Sierra Leone, Liberia, and Guinea. It is formatted in a well know [geojson](http://geojson.org/) format.
